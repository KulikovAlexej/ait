...
APP.controller('Panel', function($scope){
	...
	$scope.selectMatch = function(event){
		...
		//возвращаем объкт матча - данные должны уйти на сервер и оттуда мы должны получить похожие матчи
		return event;
	}
	...
	$scope.translationOnPanel = function(){
		...
		// console.log(source);
		var elem = angular.element(document.querySelector(".left_list thead tr td").length());
